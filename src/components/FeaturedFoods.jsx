...
const FeaturedFoods = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto p-4">
      <h2 className="text-3xl font-bold mb-6 text-center text-green-600">Featured Foods</h2>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        {featuredFoods.map((food) => (
          <div key={food._id} className="border rounded-lg shadow-md p-4">
            <img
              src={food.foodImage}
              alt={food.foodName}
      ...
      <div className="text-center mt-6">
        <button
          className="px-20 py-2  bg-green-500 text-white rounded hover:bg-green-600"
